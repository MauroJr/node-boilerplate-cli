export default function readmeTemplate({ name, description, license, }) {
  return `${''
  }[![travis build](https://img.shields.io/travis/MY_GITHUB_USER/${name}.svg?style=flat)](https://travis-ci.org/MY_GITHUB_USER/${name})
